        ...
        <div class="card shadow">
            <div class="card-header border-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">Editar Gramática</h3>
                    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('gramatica.update',$gramatica->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <label>Video</label>
                        <input type="text" class="form-control" name="link" value="{{ old('link', $gramatica->link) }}" required>
                    </div>                        
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Enlace</label>
                        <input type="text" class="form-control" name="enlace" value="{{ old('enlace', $gramatica->enlace) }}" required>
                    </div>  
