          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Ponunciación</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Pronunciacion::count() }}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Gramática</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Gramatica::count() }}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pruebas</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Pruebas::count() }}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Trucos</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Trucos::count() }}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Memes</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Memes::count() }}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Temas</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Temas::count() }}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Entrevistas</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Entrevistas::count() }}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Examenes</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Examenes::count() }}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Innovación</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{ \App\Models\Innovacion::count() }}
  ...
  <script>
   var ctx = document.getElementById('miGrafica').getContext('2d');
    var miGrafica = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ['Lecciones', 'Ejercicios', 'Juegos', 'Recursos', 'Pronunciación', 'Gramática', 'Pruebas', 'Trucos', 'Videos', 'Memes', 'Historias', 'Temas', 'Entrevistas', 'Examenes', 'Innovación', 'Eventos'],
            datasets: [{
                label: 'Mi Dataset',
                data: [{{ \App\Models\Lecciones::count() }}, {{ \App\Models\Ejercicios::count() }},   {{ \App\Models\Juegos::count() }}, {{ \App\Models\Recursos::count() }}, {{ \App\Models\Pronunciacion::count() }}, {{ \App\Models\Gramatica::count() }}, {{ \App\Models\Pruebas::count() }}, {{ \App\Models\Trucos::count() }}, {{ \App\Models\Videos::count() }}, {{ \App\Models\Memes::count() }}, {{ \App\Models\Historias::count() }}, {{ \App\Models\Temas::count() }}, {{ \App\Models\Entrevistas::count() }}, {{ \App\Models\Examenes::count() }}, {{ \App\Models\Innovacion::count() }}, {{ \App\Models\Eventos::count() }} ],
                backgroundColor: [
                  'rgba(165, 94, 234, 1)',
                  'rgba(217, 17, 255, 1)',
                  'rgba(255, 64, 64, 1)',
