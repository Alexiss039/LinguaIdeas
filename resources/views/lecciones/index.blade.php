      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="tab-container">
          ...
          <div class="tab-content">
                        ...
                        <div class="col-lg-3 mt-4 mt-lg-0 pt-4" data-aos="fade-up" data-aos-delay="400">
                          <div class="box">                    
                            ...
                            <div class="likes-buttons">
                              ...
                              <form method="POST" action="{{ route('lecciones.like', ['id' => $recurso->id]) }}">
                                @csrf
            ...
            @if (App\Models\Lecciones::where('tipo', 'multimedia')->count() > 0)
                <div class="row">
                            ...
                            <div class="col-lg-3 mt-4 mt-lg-0 pt-4" data-aos="fade-up" data-aos-delay="400">
                              ...
                              <?php echo html_entity_decode($multimedia->link); ?>
                                ...
                                <div class="likes-buttons">
                                  ...
                                  <form method="POST" action="{{ route('lecciones.like', ['id' => $multimedia->id]) }}">
                                    @csrf
                            ...
                            <div class="col-lg-3 mt-4 mt-lg-0 pt-4" data-aos="fade-up" data-aos-delay="400">
                              <div class="box">
                                ...
                                <div class="likes-buttons">
                                  ...
                                  <form method="POST" action="{{ route('lecciones.like', ['id' => $enlace->id]) }}">
                                    @csrf
