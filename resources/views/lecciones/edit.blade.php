    ...
    <div class="col-6">
        <div class="card shadow">
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="d-flex justify-content-end px-5">
                        <a href="{{ route('lecciones.lista')}}" class="btn-get-started">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('lecciones.update',$lecciones->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <label>Video</label>
                        <input type="text" class="form-control" name="link" value="{{ old('link', $lecciones->link) }}" required>
                    </div>                        
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Enlace</label>
                        <input type="text" class="form-control" name="enlace" value="{{ old('enlace', $lecciones->enlace) }}" required>
                    </div>  
