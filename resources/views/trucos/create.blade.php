                      ...
                      <div class="card mb-4">
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('trucos.store')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                                          ...
                                          <button type="submit" class="btn-get-started">Registrar truco</button>
                                          </div>                
                              </form>
                          </div>
                      </div>
                      ...
                      <div class="card mb-4">
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('trucos.store')}}" method="POST">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                                          <div class="form-group">
