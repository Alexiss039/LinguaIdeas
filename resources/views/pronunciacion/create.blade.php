                  ...
                  <div class="col-6">
                      <div class="card mb-4">
                          <div class="card-header pb-0">
                            <h6>Registro de Pronunciación</h6>
                          </div>
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('pronunciacion.store')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                                          ...
                                          <button type="submit" class="btn-get-started">Registrar pronunciación</button>
                                          </div>                
                              </form>
                          </div>
                      </div>
                      ...
                      <div class="card mb-4">
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('pronunciacion.store')}}" method="POST">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                                          <div class="form-group">
