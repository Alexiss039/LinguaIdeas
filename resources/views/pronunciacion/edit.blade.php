        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('pronunciacion.update',$pronunciacion->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Video</label>
                        <input type="text" class="form-control" name="link" value="{{ old('link', $pronunciacion->link) }}" required>
                    </div>                        
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Enlace</label>
                        <input type="text" class="form-control" name="enlace" value="{{ old('enlace', $pronunciacion->enlace) }}" required>
                    </div>  
