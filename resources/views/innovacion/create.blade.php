                  ...
                  <div class="col-6">
                      <div class="card mb-4">
                          <div class="card-header pb-0">
                            <h6>Registro de innovación y tendencias</h6>
                          </div>
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('innovacion.store')}}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                      ...
                      <div class="card mb-4">
                          ...
                          <div class="card-body px-5 pt-0 pb-2">
                              @if($errors->any())
                                      ...
                                      @endforeach
                              @endif
                              <form action="{{ route('innovacion.store')}}" method="POST">
                                      @csrf
                                          <!-- <label>Tipo</label> -->
                                          <div class="form-group">
