                ...
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Entrevistas</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Trucos</p>
                    </div>
                    <h4 class="font-weight-bolder">17</h4>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Examenes</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Eventos</p>
                    </div>
  ...
  <script>
   var ctx = document.getElementById('miGrafica').getContext('2d');
    var miGrafica = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ['Entrevistas', 'Trucos', 'Examenes', 'Eventos'],
            datasets: [{
                label: 'Mi Dataset',
                data: [10, 20, 30, 40],
                backgroundColor: [
